<div class="mt-3" style="position: absolute; width: 100%; left: 0;">
    <div class="row justify-content-end">
        ...
        <div class="col-6 col-sm-3 px-4">
            <span class="small float-end">&copy; {{ date('Y') }} {{ env('APP_NAME', 'BearSchedule') }}</span>
        </div>
    </div>
